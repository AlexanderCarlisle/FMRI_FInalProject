...
# to test within subjects or across subjects, edit line 46 to either testAcrossSubjects or testWithinSubjects()
# for testing within subjects, testSubjects is irrelevant, because our test data
# is derived from the same subjects that we trained on (just different runs)
trainSubjects = [1,2,4]
testSubjects = [3]
